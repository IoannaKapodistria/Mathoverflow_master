                ...
                if (answersNumber === 0) {
                    ...
                    for (const user of users) {
                        if (user.user_id === question.UserUserId) {
                            ...
                            const questionObject = { answers: answersNumber, votes: votesSum, title: question.title, created: question.createdAt, user: await this.getUserObject(user), question_id: question.question_id };
