...
export async function postQuestion(data: any) {
    ...
    let respone = await ky
        .post(`https://${location.hostname}:${location.port}/ask`, {
            mode: "cors",
            credentials: "include",
...
export async function getQuestions() {
    try {
        let response = await ky
            .get(`https://${location.hostname}:${location.port}/questions`, {
                mode: "cors",
                credentials: "include",
...
export async function getQuestion(id: any) {
    try {
        let response = await ky
            .get(`https://${location.hostname}:${location.port}/questions/${id}`, {
                mode: "cors",
                credentials: "include",
...
export async function getAnswer(id: any) {
    try {
        let response = await ky
            .get(`https://${location.hostname}:${location.port}/answers/${id}`, {
                mode: "cors",
                credentials: "include",
...
export async function postAnswer(data: any) {
    console.log(data, " these are data");
    let respone = await ky
        .post(`https://${location.hostname}:${location.port}/answer`, {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function getUsers() {
    try {
        let response = await ky
            .get(`https://${location.hostname}:${location.port}/users`, {
                mode: "cors",
                credentials: "include",
                headers: {
                    "content-type": "application/json",
...
export async function getUser(id: any) {
    try {
        let response = await ky
            .get(`https://${location.hostname}:${location.port}/users/${id}`, {
                mode: "cors",
                credentials: "include",
                headers: {
                    "content-type": "application/json",
...
export async function isLogged() {
    try {
        let response = await ky
            .get(`https://${location.hostname}:${location.port}/islogged`, {
                mode: "cors",
                credentials: "include",
                headers: {
                    "content-type": "application/json",
...
export async function signUp(data: any) {
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/signup`, {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function signIn(data: any) {
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/signin`, {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function signOut() {
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/signout`, {
            mode: "cors",
            credentials: "include",
            headers: {
                "content-type": "application/json",
...
export async function checkSession() {
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/sessionCheck`, {
            mode: "cors",
...
export async function voteQuestion(data: any) {
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/vote`, {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function deleteQuestion(id: any) {
    let response = await ky
        .delete(`https://${location.hostname}:${location.port}/delete_question/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function deleteAnswer(id: any) {
    let response = await ky
        .delete(`https://${location.hostname}:${location.port}/delete_answer/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function removeUser(id: any) {
    let response = await ky
        .delete(`https://${location.hostname}:${location.port}/delete_user/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function voteAnswer(data: any) {
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/answer_vote`, {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function updateQuestion1(id: number, value: any) {
    let response = await ky
        .put(`https://${location.hostname}:${location.port}/update_question/${id}`, {
            mode: "cors",
...
export async function updateAnswer1(id: number, value: any) {
    let response = await ky
        .put(`https://${location.hostname}:${location.port}/update_answer/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function postUserReputation(data: any) {
    console.log(data, " these are data");
    let respone = await ky
        .post(`https://${location.hostname}:${location.port}/create_reputation`, {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function getUserReputation(id: number) {
    let response = await ky
        .get(`https://${location.hostname}:${location.port}/get_reputation/${id}`, {
            mode: "cors",
            credentials: "include",
            headers: {
                "content-type": "application/json",
...
export async function createHistorical(data: any) {
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/create_historical`, {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function getUserHistorical(id: number) {
    let response = await ky
        .get(`https://${location.hostname}:${location.port}/get_historical/${id}`, {
            mode: "cors",
            credentials: "include",
            headers: {
                "content-type": "application/json",
...
export async function updateReputation1(id: number, value: any) {
    let response = await ky
        .put(`https://${location.hostname}:${location.port}/update_reputation/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function updateVote1(id: number, value: any) {
    let response = await ky
        .put(`https://${location.hostname}:${location.port}/update_vote/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function updateAnswerVote1(id: number, value: any) {
    let response = await ky
        .put(`https://${location.hostname}:${location.port}/update_answer_vote/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function getUserAnswerVotes(id: number, data: any) {
    console.log(data, " these are data");
    let response = await ky
        .post(`https://${location.hostname}:${location.port}/get_user_answer_vote/${id}`, {
            mode: "cors",
            credentials: "include",
            body: JSON.stringify(data),
            headers: {
...
export async function deleteVote(id: any) {
    let response = await ky
        .delete(`https://${location.hostname}:${location.port}/delete_vote/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function deleteAnswerVote(id: any) {
    let response = await ky
        .delete(`https://${location.hostname}:${location.port}/delete_answer_vote/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
