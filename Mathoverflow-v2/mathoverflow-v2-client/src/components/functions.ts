...
export async function postQuestion(data: any) {
    ...
    let respone = await ky
        .post("http://192.168.1.3:3000/ask", {
            mode: "cors",
            credentials: "include",
...
export async function getQuestions() {
    try {
        let response = await ky
            .get("http://192.168.1.3:3000/questions", {
                mode: "cors",
                credentials: "include",
...
export async function getQuestion(id: any) {
    try {
        let response = await ky
            .get(`http://192.168.1.3:3000/questions/${id}`, {
                mode: "cors",
                credentials: "include",
...
export async function getAnswer(id: any) {
    try {
        let response = await ky
            .get(`http://192.168.1.3:3000/answers/${id}`, {
                mode: "cors",
                credentials: "include",
...
export async function postAnswer(data: any) {
    console.log(data, " these are data");
    let respone = await ky
        .post("http://192.168.1.3:3000/answer", {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function getUsers() {
    try {
        let response = await ky
            .get("http://192.168.1.3:3000/users", {
                mode: "cors",
                credentials: "include",
                headers: {
                    "content-type": "application/json",
...
export async function getUser(id: any) {
    try {
        let response = await ky
            .get(`http://192.168.1.3:3000/users/${id}`, {
                mode: "cors",
                credentials: "include",
                headers: {
                    "content-type": "application/json",
...
export async function isLogged() {
    try {
        let response = await ky
            .get("http://192.168.1.3:3000/islogged", {
                mode: "cors",
                credentials: "include",
                headers: {
                    "content-type": "application/json",
...
export async function signUp(data: any) {
    let response = await ky
        .post("http://192.168.1.3:3000/signup", {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function signIn(data: any) {
    let response = await ky
        .post("http://192.168.1.3:3000/signin", {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function signOut() {
    let response = await ky
        .post("http://192.168.1.3:3000/signout", {
            mode: "cors",
            credentials: "include",
            headers: {
                "content-type": "application/json",
...
export async function checkSession() {
    let response = await ky
        .post("http://192.168.1.3:3000/sessionCheck", {
            mode: "cors",
...
export async function voteQuestion(data: any) {
    let response = await ky
        .post("http://192.168.1.3:3000/vote", {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function deleteQuestion(id: any) {
    let response = await ky
        .delete(`http://192.168.1.3:3000/delete_question/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function deleteAnswer(id: any) {
    let response = await ky
        .delete(`http://192.168.1.3:3000/delete_answer/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function removeUser(id: any) {
    let response = await ky
        .delete(`http://192.168.1.3:3000/delete_user/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function voteAnswer(data: any) {
    let response = await ky
        .post("http://192.168.1.3:3000/answer_vote", {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function updateQuestion1(id: number, value: any) {
    let response = await ky
        .put(`http://192.168.1.3:3000/update_question/${id}`, {
            mode: "cors",
...
export async function updateAnswer1(id: number, value: any) {
    let response = await ky
        .put(`http://192.168.1.3:3000/update_answer/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function postUserReputation(data: any) {
    console.log(data, " these are data");
    let respone = await ky
        .post("http://192.168.1.3:3000/create_reputation", {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function getUserReputation(id: number) {
    let response = await ky
        .get(`http://192.168.1.3:3000/get_reputation/${id}`, {
            mode: "cors",
            credentials: "include",
            headers: {
                "content-type": "application/json",
...
export async function createHistorical(data: any) {
    let response = await ky
        .post("http://192.168.1.3:3000/create_historical", {
            mode: "cors",
            body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function getUserHistorical(id: number) {
    let response = await ky
        .get(`http://192.168.1.3:3000/get_historical/${id}`, {
            mode: "cors",
            credentials: "include",
            headers: {
                "content-type": "application/json",
...
export async function updateReputation1(id: number, value: any) {
    let response = await ky
        .put(`http://192.168.1.3:3000/update_reputation/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function updateVote1(id: number, value: any) {
    let response = await ky
        .put(`http://192.168.1.3:3000/update_vote/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function updateAnswerVote1(id: number, value: any) {
    let response = await ky
        .put(`http://192.168.1.3:3000/update_answer_vote/${id}`, {
            mode: "cors",
            body: JSON.stringify(value),
            credentials: "include",
            headers: {
...
export async function getUserAnswerVotes(id: number, data: any) {
    console.log(data, " these are data");
    let response = await ky
        .post(`http://192.168.1.3:3000/get_user_answer_vote/${id}`, {
            mode: "cors",
            credentials: "include",
            body: JSON.stringify(data),
            headers: {
...
export async function deleteVote(id: any) {
    let response = await ky
        .delete(`http://192.168.1.3:3000/delete_vote/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
...
export async function deleteAnswerVote(id: any) {
    let response = await ky
        .delete(`http://192.168.1.3:3000/delete_answer_vote/${id}`, {
            mode: "cors",
            // body: JSON.stringify(data),
            credentials: "include",
            headers: {
